...
public class Printer_Main_Activity extends Activity implements OnClickListener {
    //
    String empName="";

    /******************************************************************************************************/
    // Debugging
    private static final String TAG = "Printer_Main_Activity";
...
//	private TextView mTitle;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.printer_main_activity_layout);
...
//		mTitle.setText(R.string.app_title);
        ...
        // name
        empName = user.get(SessionManager.KEY_NAME);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            case R.id.button_scan: {
                Intent serverIntent = new Intent(Printer_Main_Activity.this, DeviceListActivity.class);
            ...
            case R.id.Send_Button: {
                if (hexBox.isChecked()) {
                    ...
                    if (str.length() > 0) {
                        ...
                        Toast.makeText(Printer_Main_Activity.this, getText(R.string.empty), Toast.LENGTH_SHORT).show();
                    }
                } else {
...
//				Command.ESC_Align[2] = 0x01;
    ...
    private void printBarCode() {
        ...
        new AlertDialog.Builder(Printer_Main_Activity.this).setTitle(getText(R.string.btn_prtcode))
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        if (which == 0) {
                            if (str.length() == 11 || str.length() == 12) {
                                ...
                                Toast.makeText(Printer_Main_Activity.this, getText(R.string.msg_error), Toast.LENGTH_SHORT).show();
                                return;
                            }
                        } else if (which == 1) {
                            ...
                            if (str.length() == 0) {
                                Toast.makeText(Printer_Main_Activity.this, getText(R.string.empty1), Toast.LENGTH_SHORT).show();
                                return;
                            } else {
    ...
    private void CommandTest() {
        ...
        String lang = getString(R.string.strLang);
        if ((lang.compareTo("cn")) == 0) {
            new AlertDialog.Builder(Printer_Main_Activity.this).setTitle(getText(R.string.chosecommand))
